...
*Figura 21 - Reabertura de pedido*. <br>
...
*Figura 22 - Modal "Abas do pedido"*. <br><br>
...
<ul>
<li style="text-align: justify;">Complementar o serviço de afastamento bancário com anexação da decisão judicial (Figura 25). </li>
</ul>

![Login](img/AnexarDecisãoJudicial.png)
*Figura 25 - Anexar decisão judicial*. <br>

<p style="text-align: justify;">Ao clicar no botão "Anexar Decisão Judicial", uma nova janela será aberta, conforme imagem a seguir (Figura 26). </p>

![Login](img/CompletarDecisãoJudicial.png)<br>
*Figura 26 - Completar decisão judicial*. <br><br>
<ul>
<li style="text-align: justify;">Baixar a minuta de afastamento de sigilo bancário (Figura 27). </li>
</ul>

![Login](img/GerarNovaMinuta.png)<br>
*Figura 27 - Baixar minuta*. <br><br>

<ul>
<li>Obter as informações de contatos das instituições financeiras e de seus funcionários responsáveis pelas transmissões de dados (Figuras 28). </li>
</ul>
...
<p style="text-align: justify;">Ao clicar no botão "Contatos", uma nova janela será aberta, conforme imagem a seguir (Figura 29). </p>
...
*Figura 30 - Acessar relatórios*. <br>

<ul>
<li style="text-align: justify;">Visualizar a lista de investigados e a situação de suas respectivas contas em relação às transmissões. São duas tabelas, a primeira agrupada por investigado (Figura 31) e a segunda por banco (Figura 32): </li>
</ul>

![Login](img/Investigados.png)
*Figura 31 - Investigados*. <br>

![Login](img/AbaBancos.png)
*Figura 32 - Bancos*. <br>

<p style="text-align: justify;">A partir dessa janela, clicando em "Detalhes", poderão ser obtidas outras informações a respeito das transmissões como, por exemplo, dados do investigado, números de contas, agências e bancos, nível de identificação da origem e destino, períodos etc. (Figura 33) </p>  

![Login](img/ContasRelacionadas.png)
*Figura 33 - Aba "Contas Relacionadas"*. <br>
...
<ul>
<li style="text-align: justify;">Complementar a ordem de afastamento com anexação da ordem judicial (Figura 34) ou do ofício extrajudicial, conforme o caso.</li>
</ul>

![Login](img/CompletarOficio.png)<br>
*Figura 34 - Complementar Ofício.* <br>

<ul>
<li style="text-align: justify;">Baixar a minuta de afastamento de sigilo telefônico</li>
<li style="text-align: justify;">Visualizar a lista de alvos, tipo de dados solicitados (interlocutores, ERB, conexão, etc.) e a situação das respectivas transmissões de dados das operadoras de telefonia (Figura 35).</li>
</ul>

![Login](img/SolicitacoesOperadoras.png)<br>
*Figura 35 - Status das solicitações enviadas para as operadoras.* <br>

<ul>
<li>Cadastrar alvos (Figura 36). Os tipos de requisição disponíveis são: </li> 
...
<p style="text-align: justify;">Aba de acompanhamento do afastamento de sigilo fiscal do caso (Figura 37), onde é possível anexar os arquivos de dados fiscais, baixar minuta e cadastrar investigados (pessoa física ou pessoa jurídica). </p>

![Login](img/AbaSifisco.png)<br>
*Figura 37 - Aba SIFISCO*.<br><br><br>
