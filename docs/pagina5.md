...
*Figura 41 - Delegar pedido.* <br><br>

<p style="text-align: justify;"><span style="background-color: #c9ebff; border-radius: 5px; padding: 7px; color: #000000; font-weight: bold; ">3</span> Caso o sistema retorne a mensagem <span style="color: red;">"Atenção, usuário não encontrado."</span>, será necessário realizar um novo cadastro. Basta clicar no botão "Cadastrar" e prencher os campos nome e telefone/celular do novo usuário (Figura 42). Este será alocado na mesma lotação do membro que o cadastrou. Ao finalizar o cadastro, basta proseguir com a delegação. </p>

![Login](img/CadastrarDelegação.png)<br>
*Figura 42 - Cadastrar novo usuário a ser delegado.* <br><br>
...
*Figura 43 - Delegação x Autorização*. <br><br>
